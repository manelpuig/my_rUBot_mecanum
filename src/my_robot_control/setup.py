...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'my_robot_selfcontrol_exec2 = my_robot_control.my_robot_selfcontrol2:main',
            ...
            'my_robot_wallfollower_differential_exec = my_robot_control.my_rubot_wallfollower_differential:main',
